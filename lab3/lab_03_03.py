...
print("set1 & set2: ", set1 & set2) # присутствие в обоих множествах
print("set1 ^ set2: ", set1 ^ set2) # присутствие только в одном из множеств
set1.update(set2) # добавить элементы другого множества
set2.add("t") # добавить элемент
set2.add("u")
print("Добавление в множество set1 элементов множества set2 с использованием функции update(): ", set1)
print("Добавление элементов во множество set2 с использованием функции add(): ", set2)
...
set3 = frozenset(set1)
print("set3 = ", set3)
set3.remove("q") # выводится ошибка, т. к. frozenset - неизменяемое множество, для которого недоступны операции, связанные с изменением значений.
