...
if p > 10:
    print("Количество выполненных за год лабораторных работ: ", p)
if p > 10: print("Количество выполненных за год лабораторных работ: ", p)
...
if a > b:
    ...
    print ("Произведение чисел a и b: ", (b * a))
