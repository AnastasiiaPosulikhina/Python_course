...
for i in range(0, 10):
    list1.append(int(input())) # ввод элементов списка с клавиатуры
list1.sort(reverse=True) # сортировка элементов списка по убыванию
print ("Последние 5 элементов списка: ", list1[5:])
list2 = list1.copy()
print("Список до реверсирования значений: ", list2)
list2.sort(reverse=False) # сортировка элементов списка по возрастаниию
print("Список после реверсирования значений: ", list2)